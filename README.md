# Templates
zad1
1. Napisz funkcję, która porównuje dwie liczby i stwierdza, która jest większa w dwóch wersjach: I – funkcja bez wzorców, II – funkcja wykorzystująca wzorce.
2. Używając typeid sprawdź w funkcjach z 1 zad. jakich typów są danę.
